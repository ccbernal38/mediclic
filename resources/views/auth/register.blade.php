                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Primer Nombre</label>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Segundo Nombre</label>

                            <div class="col-md-6">
                                <input id="primer_nombre" type="text" class="form-control @error('segundo_nombre') is-invalid @enderror" name="segundo_nombre" value="{{ old('segundo_nombre') }}" required autocomplete="segundo_nombre" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Tipo de documento</label>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Número de documento</label>

                            <div class="col-md-6">
                                <input id="no_documento" type="text" class="form-control @error('no_documento') is-invalid @enderror" name="no_documento" value="{{ old('no_documento') }}" required autocomplete="no_documento" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Terminos y condiciones</label>

                            <div class="col-md-6">
                                <input id="terminos" type="text" class="form-control @error('terminos') is-invalid @enderror" name="terminos" value="{{ old('terminos') }}" required autocomplete="terminos" autofocus>
